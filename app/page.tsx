...
export default function Home() {
  ...
  const infoCards = [
    { title: "Total Customers", value: "1,250", badge: "", info: "Since last week",  link: "/sales" },
    { title: "Total Sales", value: "1,250", badge: "2.5%", info: "Since last week", icon: <LuBox/>, link: "/sales" },
    { title: "Total Raw Materials", value: "1,250", badge: "2.5%", info: "Since last week", icon: <LuBox />, link: "/sales" },
  ]
